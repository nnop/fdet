...
def run_main():
    ...
    save_dir = "models/VGGNet/pose/{}".format(job_name)
    snapshot_dir = "models/VGGNet/pose/{}".format(job_name)
    job_dir = "jobs/VGGNet/pose/{}".format(job_name)
    output_result_dir = "data/pose/results/{}/Main".format(job_name)
    ...
    # Stores LabelMapItem.
    label_map_file = "data/pose/labelmap_person.prototxt"
